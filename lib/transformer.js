...
class Transformer {
   ...
   *
   * @param {string|Buffer} code - Original JavaScript source.
   * @param {'esm'|'cjs'} moduleType - Whether the source is an ES module or CommonJS.
   * @param {object|null} [sourcemap] - Existing source map to chain from.
  ...
  transform (code, moduleType, sourcemap) {
    ...
    let sourceType = moduleType === 'esm' ? 'module' : 'script'
    let ast
    let aliases = {}
